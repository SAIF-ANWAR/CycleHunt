    ...
    return (
        <div className="card w-1/2 mx-auto bg-base-100 shadow-xl">
            <div className="card-body">
                <h2 className="card-title mt-2">Q-1:  How will you improve the performance of a React Application?</h2>
                ...
                <h2 className="card-title mt-2">Q-2: What are the different ways to manage a state in a React application?</h2>
                <p>Ans: 1. Local State  <br /> 2.  Global State <br /> 3. Server State <br /> 4. URL state</p>

                <h2 className="card-title mt-2">Q-3:  Why you do not set the state directly in React.?</h2>
                ...
                <h2 className="card-title mt-2">Q-4:   You have an array of products. Each product has a name, price, description, etc. How will you implement a search to find products by name?</h2>
                ...
                <h2 className="card-title mt-2">Q-5:  What is a unit test? Why should write unit tests?</h2>
